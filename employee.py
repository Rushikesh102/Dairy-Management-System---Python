...
class employee:
    def __init__(self, root):
        ...
        btn_search=Button(SearchFrame,command=self.search,text="Search",bg="#4caf50",fg="white",font=("goudy old style",15),cursor="hand2").place(x=440,y=8, width=150,height=30)

        title=Label(self.root,text="Employee Details",font = ("goudy old style",15),bg="#0f4d7d",fg="white").place(x=100,y=100,width=1000)
        lbl_empid = Label(self.root, text="Emp ID :", font=("goudy old style", 15), bg="white").place(x=100, y=150)
        ...
        lbl_name = Label(self.root, text="Name :", font=("goudy old style", 15), bg="white").place(x=100, y=190)
        ...
        lbl_email = Label(self.root, text="Email :", font=("goudy old style", 15), bg="white").place(x=100, y=230)
        ...
        txt_password = Entry(self.root, textvariable=self.var_pass, font=("goudy old style", 15), bg="lightyellow").place(x=550, y=230, width=180)
        ...
        lbl_address = Label(self.root, text="Address :", font=("goudy old style", 15), bg="white").place(x=100, y=270)
        lbl_salary = Label(self.root, text="Salary :", font=("goudy old style", 15), bg="white").place(x=550, y=270)

        self.txt_address = Text(self.root, font=("goudy old style", 15), bg="lightyellow")
        self.txt_address.place(x=200, y=270, width=300,height=60)
        ...
        btn_add = Button(self.root, text="Save",command=self.add, bg="#2196f3", fg="white", font=("goudy old style", 15),cursor="hand2").place(x=550, y=305, width=110, height=28)
        btn_update = Button(self.root, text="Update",command=self.update, bg="#4caf50", fg="white", font=("goudy old style", 15),cursor="hand2").place(x=670, y=305, width=110, height=28)
        btn_delete = Button(self.root, text="Delete",command=self.delete, bg="#f44336", fg="white", font=("goudy old style", 15),cursor="hand2").place(x=790, y=305, width=110, height=28)
        btn_clear = Button(self.root, text="Clear",command=self.clear, bg="#607d8b", fg="white", font=("goudy old style", 15),cursor="hand2").place(x=910, y=305, width=110, height=28)




        emp_frame=Frame(self.root,bd=3,relief=RIDGE)
        emp_frame.place(x=0,y=350,relwidth=1,height=250)
    ...
    def add(self):
        ...
        cur=con.cursor()
        try:
            if self.var_emp_id.get()=="" or self.var_name=="":
                messagebox.showerror("Error","Employee Details Required",parent=self.root)
            else:
    ...
    def search(self):
        ...
        try:
            if self.var_searchby =="Select":
                messagebox.showerror("Error","Select an Option!",parent=self.root)
